...
DEFAULT_ROOTS = {
    "DAN": Path("outputs/DAN"),
    "DSAN": Path("outputs/DSAN"),
    "DANN": Path("outputs/DANN"),
}
DEFAULT_OUT_DIR = Path("outputs")
DEFAULT_FT_SUMMARY = Path(
    "outputs/FT/finetune_full_stft_r0.10_summary_20260922_023523.json"
)
